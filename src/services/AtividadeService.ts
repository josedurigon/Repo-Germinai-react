...
export interface Atividade {
  ...
  data: string; // data principal da atividade
  dataRegistro: string; // data em que o registro foi criado
  dataVencimento?: string; // data de vencimento/entrega da atividade
...
const MOCK_ATIVIDADES: Atividade[] = [
  {
    ...
    dataRegistro: new Date(new Date().getFullYear(), new Date().getMonth() - 2, 15).toISOString().split('T')[0],
    cultura: 'Milho',
    custo: 1500,
  ...
  },
  {
    ...
    dataRegistro: new Date(new Date().getFullYear(), new Date().getMonth() - 1, 10).toISOString().split('T')[0],
    cultura: 'Milho',
    custo: 450,
  ...
  },
  {
    ...
    dataRegistro: new Date(new Date().getFullYear(), new Date().getMonth(), 5).toISOString().split('T')[0],
    cultura: 'Milho',
    custo: 800,
    responsavel: 'João Silva',
    dataVencimento: undefined,
  },
  {
    ...
    dataRegistro: new Date(new Date().getFullYear(), new Date().getMonth(), 1).toISOString().split('T')[0],
    cultura: 'Milho',
    custo: 600,
    responsavel: 'Pedro Oliveira',
    dataVencimento: new Date(new Date().getFullYear(), new Date().getMonth(), 15).toISOString().split('T')[0],
  },
  {
    id: 'mock-005',
    ...
    dataVencimento: new Date(new Date().getFullYear(), new Date().getMonth() + 1, 20).toISOString().split('T')[0],
  },
  {
    id: 'mock-006',
    ...
    dataRegistro: new Date(new Date().getFullYear(), new Date().getMonth(), 10).toISOString().split('T')[0],
    custo: 1200,
  ...
  },
  {
    ...
    dataRegistro: new Date(new Date().getFullYear(), new Date().getMonth() - 3, 1).toISOString().split('T')[0],
    cultura: 'Milho',
    custo: 900,
    responsavel: 'João Silva',
    dataVencimento: undefined,
  },
  {
    ...
    status: 'cancelada',
    data: new Date(new Date().getFullYear(), new Date().getMonth() - 1, 20).toISOString().split('T')[0],
    dataRegistro: new Date(new Date().getFullYear(), new Date().getMonth() - 1, 20).toISOString().split('T')[0],
    cultura: 'Soja',
    custo: 400,
    responsavel: 'Maria Costa',
...
class AtividadeService {
  ...
  async listarAtividades(): Promise<Atividade[]> {
    ...
    return this.ler<Atividade>(CHAVE_ATIVIDADES).sort((a, b) => {
      const dateB = new Date(b.dataRegistro || b.data).getTime();
      const dateA = new Date(a.dataRegistro || a.data).getTime();
      return dateB - dateA;
    });
  }

  // Criar atividade
  async criarAtividade(dados: Omit<Atividade, 'id' | 'dataRegistro' | 'codigoIdentificacao'>): Promise<Atividade> {
    const nova: Atividade = {
      ...dados,
      id: this.gerarId(),
      codigoIdentificacao: this.gerarCodigoIdentificacao(),
      dataRegistro: new Date().toISOString().split('T')[0],
      // aceitar dataVencimento caso tenha sido informada
      dataVencimento: (dados as any).dataVencimento,
    };
